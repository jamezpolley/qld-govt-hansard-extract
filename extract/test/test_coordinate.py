...
def test_upper_left_most_coordinate():
    coordinates = [
    ...
    coord = upper_left_most_coordinate(coordinates)

    assert coord.x == 466.681
    assert coord.y == 788.160


def test_lower_right_most_coordinate():
    coordinates = [
    ...
    coord = lower_right_most_coordinate(coordinates)

    assert coord.x == 527.287
    assert coord.y == 801.755
